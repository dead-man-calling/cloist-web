...
import { defaultExceptionMessage, regKorName, regPhone, expiredExceptionMessage } from '../constant';
...
const Exception = (props) => {
    ...
    const [resultMessage, setResultMessage] = useState(expiredExceptionMessage);
